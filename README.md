...
> [!IMPORTANT]
> 本项目是 [Sliverkiss/workbuddy2api-gui](https://github.com/Sliverkiss/workbuddy2api-gui) 的二次开发版，原始项目作者为 **Sliverkiss**，原项目采用 MIT 许可证。
>
> 本版本在原作者成果基础上补充了：
> - 「请求统计」页支持点击模型名，展开最近请求详情；
> - Token 明细、响应时间、推理程度、缓存命中等逐请求观测；
> - 与网关端 `/v1/stats/details` 对接所需的代理与界面。
>
> 原项目的版权与许可证声明保留在 [LICENSE](LICENSE) 中；本项目仅用于学习、研究和个人授权账号的私有环境测试。
